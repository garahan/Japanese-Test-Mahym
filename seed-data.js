...
/* ===================== LESSON 25 ===================== */
{
  ...
  vocabulary: [
    ...
    { id: "L25v11", word: "借ります", reading: "かります", pitch: 3, meaning: "to borrow; to rent", example: "図書館で本を借りました。", exampleMeaning: "I borrowed a book from the library." },
    { id: "L25v12", word: "返します", reading: "かえします", pitch: 3, meaning: "to return (something)", example: "来週、本を返します。", exampleMeaning: "I'll return the book next week." },
    { id: "L25v13", word: "紹介します", reading: "しょうかいします", pitch: 0, meaning: "to introduce", example: "友達を紹介します。", exampleMeaning: "I'll introduce my friend." },
    { id: "L25v14", word: "案内します", reading: "あんないします", pitch: 0, meaning: "to guide; to show around", example: "町を案内してあげます。", exampleMeaning: "I'll show you around town." },
    { id: "L25v15", word: "説明します", reading: "せつめいします", pitch: 0, meaning: "to explain", example: "もう一度説明してください。", exampleMeaning: "Please explain once more." },
    { id: "L25v16", word: "覚えます", reading: "おぼえます", pitch: 3, meaning: "to memorize; to remember", example: "単語を覚えました。", exampleMeaning: "I memorized the vocabulary." },
    { id: "L25v17", word: "忘れます", reading: "わすれます", pitch: 3, meaning: "to forget", example: "かぎを忘れました。", exampleMeaning: "I forgot my keys." },
    { id: "L25v18", word: "降ります", reading: "ふります", pitch: 2, meaning: "to fall (rain/snow)", example: "雨が降ったら、中止します。", exampleMeaning: "If it rains, we'll cancel." },
    { id: "L25v19", word: "集めます", reading: "あつめます", pitch: 3, meaning: "to collect; to gather (things)", example: "切手を集めています。", exampleMeaning: "I collect stamps." },
    { id: "L25v20", word: "直します", reading: "なおします", pitch: 4, meaning: "to fix; to repair; to correct", example: "時計を直してもらいました。", exampleMeaning: "I had my watch fixed." },
    { id: "L25v21", word: "壊れます", reading: "こわれます", pitch: 3, meaning: "to break; to be broken", example: "パソコンが壊れました。", exampleMeaning: "My computer broke." },
    { id: "L25v22", word: "割れます", reading: "われます", pitch: 3, meaning: "to break; to crack (glass/plate)", example: "コップが割れました。", exampleMeaning: "The glass broke." },
    { id: "L25v23", word: "趣味", reading: "しゅみ", pitch: 1, meaning: "hobby", example: "趣味は読書です。", exampleMeaning: "My hobby is reading." },
    { id: "L25v24", word: "興味", reading: "きょうみ", pitch: 1, meaning: "interest", example: "歴史に興味があります。", exampleMeaning: "I'm interested in history." },
    { id: "L25v25", word: "経験", reading: "けいけん", pitch: 0, meaning: "experience", example: "いい経験になりました。", exampleMeaning: "It was a good experience." },
    { id: "L25v26", word: "結婚", reading: "けっこん", pitch: 0, meaning: "marriage", example: "結婚したら、両親と一緒に住みます。", exampleMeaning: "When I get married, I'll live with my parents." },
    { id: "L25v27", word: "両親", reading: "りょうしん", pitch: 1, meaning: "parents", example: "両親に手紙を書きました。", exampleMeaning: "I wrote a letter to my parents." },
    { id: "L25v28", word: "旅行", reading: "りょこう", pitch: 1, meaning: "travel; trip", example: "旅行に行ったら、お土産を買います。", exampleMeaning: "If I go on a trip, I'll buy souvenirs." },
    { id: "L25v29", word: "最近", reading: "さいきん", pitch: 0, meaning: "recently; lately", example: "最近、忙しいです。", exampleMeaning: "I've been busy recently." },
    { id: "L25v30", word: "特に", reading: "とくに", pitch: 1, meaning: "especially", example: "特に、日本語の勉強が好きです。", exampleMeaning: "I especially like studying Japanese." }
  ],
  grammar: [
    {
      id: "L25g1",
  ...
  kanji: [
    ...
    { id: "L25k5", char: "卒", reading: "そつ", meaning: "finish; graduate", exampleWord: "卒業（そつぎょう）" },
    { id: "L25k6", char: "給", reading: "きゅう／た（める）", meaning: "grant; supply", exampleWord: "給料（きゅうりょう）" },
    { id: "L25k7", char: "料", reading: "りょう", meaning: "fee; materials", exampleWord: "給料（きゅうりょう）" },
    { id: "L25k8", char: "集", reading: "しゅう／あつ（まる）", meaning: "gather; collect", exampleWord: "集まります（あつまります）" }
  ],
  reading: {
    id: "L25r1",
    title: "卒業したら",
  ...
  questions: [
    ...
    { id: "L25q7", dim: "grammar", type: "recall", difficulty: "medium", s: "もし宝くじが当た___、家を買います。(If I won the lottery…)", a: "たら", o: ["たら", "ても", "と", "ば"], c: 0, exp: "もし ＋ たら = hypothetical 'if'.", linksTo: "L25g1" },
    { id: "L25q8", dim: "grammar", type: "recall", difficulty: "hard", s: "元気___、会社を休みます。(even if I'm fine, I'll take a day off)", a: "でも", o: ["だったら", "でも", "なら", "ので"], c: 1, exp: "na-adj/noun ＋ でも = 'even if (it's)…'", linksTo: "L25g2" },
    { id: "L25q9", dim: "vocab", type: "recognition", difficulty: "easy", s: "借ります means…", a: "to borrow / rent", o: ["to return", "to borrow / rent", "to fix", "to forget"], c: 1, exp: "借ります (かります) = to borrow/rent. 返します = to return.", linksTo: "L25v11" },
    { id: "L25q10", dim: "vocab", type: "recognition", difficulty: "medium", s: "趣味 means…", a: "hobby", o: ["interest", "hobby", "experience", "marriage"], c: 1, exp: "趣味 (しゅみ) = hobby. 興味 (きょうみ) = interest.", linksTo: "L25v23" },
    { id: "L25q11", dim: "vocab", type: "recall", difficulty: "medium", s: "単語を___ました。(memorized)", a: "覚え", o: ["覚え", "忘れ", "集め", "直し"], c: 0, exp: "覚えます = to memorize. 忘れます = to forget.", linksTo: "L25v16" },
    { id: "L25q12", dim: "kanji", type: "recognition", difficulty: "medium", s: "Which kanji means 'gather / collect'?", a: "集", o: ["業", "留", "集", "連"], c: 2, exp: "集 → 集まります / 集めます (gather/collect).", linksTo: "L25k8" }
  ]
},
